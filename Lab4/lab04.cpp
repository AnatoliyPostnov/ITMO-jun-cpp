...
int main(){
  ...
  cout << "Your code: v.at(0) = " << v.at(0) << " and v.at(3) = " << v.at(3) << endl << endl;

  cout << "Calling v[0] and v[3]..." << endl;
  cout << " Solution: v[0] = 1 and v[3] = -1" << endl;
  cout << "Your code: v[0] = " << v[0] << " and v[3] = " << v[3] << endl << endl;

  cout << "Calling const versions of cv.at(0) and cv[0]..." << endl;
  const IntVector &cv = v;
  cout << " Solution: cv[0] = 1 and cv[3] = -1" << endl;
  cout << "Your code: cv[0] = " << cv[0] << " and cv[3] = " << cv[3] << endl << endl;
  ...
  cout << "Your code: v.size() = " << v.size() << " and v.at(99) = " << v.at(99) << endl;
